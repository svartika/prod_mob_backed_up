...
int _wrap_convert_py2c__long_long_int(PyObject *value, long long int *address);


int _wrap_convert_py2c__long_int(PyObject *value, long int *address);
...
int _wrap_convert_py2c__signed_char(PyObject *value, signed char *address);
