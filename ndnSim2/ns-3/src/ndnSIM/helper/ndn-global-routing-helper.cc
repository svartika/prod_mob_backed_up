...
GlobalRoutingHelper::CalculateRoutes (bool invalidatedRoutes/* = true*/)
{
  ...
  // vartika commeneted typedef graph_traits < NdnGlobalRouterGraph >::vertex_descriptor vertex_descriptor;
...
GlobalRoutingHelper::CalculateAllPossibleRoutes (bool invalidatedRoutes/* = true*/)
{
  ...
  NdnGlobalRouterGraph graph;
 //vartika commented typedef graph_traits < NdnGlobalRouterGraph >::vertex_descriptor vertex_descriptor;
